...
// $this->title = Yii::t('app', 'Company Information');
...
<div class="company-information-index">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Tambah Informasi'), ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        /*[
                ...
                'filterInputOptions' => ['placeholder' => 'Company', 'id' => 'grid-company-information-search-company_id']
            ],*/
        'title',
        'description:ntext',
        // 'start_time',
