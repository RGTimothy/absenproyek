...
/**
 * This is the base model class for table "company_information".
 *
 * @property integer $id
...
class CompanyInformation extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \backend\models\CompanyInformationQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \backend\models\CompanyInformationQuery(get_called_class());
        return $query->where(['company_information.deleted_by' => 0]);
    }
}
