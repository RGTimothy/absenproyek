...
/**
 * This is the base model class for table "company_clock".
 *
 * @property integer $id
    ...
    */
    ...
    public function attributeLabels()
    {
        return [
            ...
            'break_hour' => Yii::t('app', 'Break Hour'),
    ...
    /**
     * @inheritdoc
     * @return \backend\models\CompanyClockQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \backend\models\CompanyClockQuery(get_called_class());
        return $query->where(['company_clock.deleted_by' => 0]);
    }
}
